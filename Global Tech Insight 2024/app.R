...
# ================== Data ==================
stackdev <- read_delim("stackdev_clean.csv", 
                             delim = ";", escape_double = FALSE, col_types = cols(CompTotal = col_number(), 
                                                                                  YearsCode = col_number(), YearsCodePro = col_number(), 
                                                                                  JobSat = col_number(), YearsCodePro_num = col_number(), 
                                                                                  Salary_USD = col_number()), trim_ws = TRUE)
